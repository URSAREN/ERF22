...
#define SONAR_NUM 34     // The number of sensors.
 ...
 *
 */
// TODO richtige Pins eintragen
NewPing sonar[SONAR_NUM] = {
    NewPing(3, 2, MAX_DISTANCE), // leftFront
    NewPing(X, X, MAX_DISTANCE), // leftBack
    NewPing(5, 4, MAX_DISTANCE), // center
...
void setup()
{
  ...
  sensor_msg_init(range_leftFront, "/ultrasound_leftFront");
  sensor_msg_init(range_leftBack, "/ultrasound_leftBack");
